...
.button.button--animate:not(.button--animate-inactive) .button__content i {
  @apply text-[1.15rem];
}

.button.button--animate:not(.button--animate-inactive):hover .button__content {
  @apply -translate-x-full;
  -webkit-transform: translate(-100%);
}

.button.button--animate:not(.button--animate-inactive):hover .button__animate {
  @apply translate-x-0;
  -webkit-transform: translate(0);
}

.button.button--animate:not(.button--animate-inactive).button--animate-vertical:hover .button__content {
  @apply -translate-y-full opacity-0;
  -webkit-transform: translateY(-100%) !important;
}

.button.button--animate:not(.button--animate-inactive).button--animate-vertical:hover .button__animate {
  @apply translate-x-0;
  -webkit-transform: translate(0) !important;
}

.button.button--animate:not(.button--animate-inactive).button--animate-scale:hover .button__content {
  @apply opacity-0 scale-[1.4];
  -webkit-transform: scale(1.4) !important;
}

.button.button--animate:not(.button--animate-inactive).button--animate-scale:hover .button__animate {
  @apply opacity-100 scale-100;
  -webkit-transform: scale(1);
}

.button.button--animate:not(.button--animate-inactive).button--animate-rotate:hover .button__content {
  @apply !rotate-180 opacity-0;
}

.button.button--animate:not(.button--animate-inactive).button--animate-rotate:hover .button__animate {
  @apply opacity-100 rotate-[0];
}

.button.button--animate:not(.button--animate-inactive) .button__content,
.button__animate {
...
.button-group .button.button--transparent {
...
.button-group .button:not(:last-of-type):not(:first-of-type).button--border:before {
  @apply w-full border-l-0;
}

.button-group .button:not(:last-of-type):not(:first-of-type).button--border+.button--border:not(:last-of-type):before {
